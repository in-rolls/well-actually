...
The [original-questionnaire audit](raw-survey-followup.md) now identifies the exact raw files for village names, caste land ranks, reported physical crop yields, and irrigation availability. Their presence in public metadata does not establish that the underlying observations have been obtained.
