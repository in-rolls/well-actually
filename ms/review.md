...
The interaction is also not itself the complete village contrast for buyers. For buyers who do not own a pump, Table 4(2) implies −₹87.98 + ₹850.94 = ₹762.96, SE ₹310.26, p = 0.0159. The paper describes yields as 45% higher in lower-caste-dominated villages (p. 253). I reproduced the rupee coefficients, but could not reproduce the calculation giving 45%. Moreover, a 45% increase from 100 to 145 is a 31% shortfall when measured from 145. Neither figure measures income knowingly sacrificed by farmers. The recorded outcome is crop sales per owned acre, not physical crop yield or profit.
