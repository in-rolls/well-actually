...
The interaction is also not itself the complete village contrast for buyers. For buyers who do not own a pump, Table 4(2) implies −₹87.98 + ₹850.94 = ₹762.96, SE ₹310.26, p = 0.0159. The supplied program contains no computation that converts this contrast, or another clearly specified contrast, into the headline 45%. I could not verify that percentage and have not invented a replacement denominator.
...
A village pairs bootstrap that re-estimates the preliminary purchase equation and the 2SLS model in every draw is considerably less precise than the reported normal approximation. Across 1,999 valid draws, its 95% percentile interval for the interaction is [−₹395, ₹8,982], compared with the published-convention interval [₹749, ₹6,290]. The bootstrap distribution has heavy tails. This is evidence of sensitivity, not a weak-instrument-robust confidence set or proof that the point estimate is biased.
