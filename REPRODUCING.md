...
The main analysis packages are `haven`, `sandwich`, `ivreg`, `fwildclusterboot`, and `dqrng`; validation and reporting use `digest`, `testthat`, `lintr`, `styler`, and `knitr`. The lockfile records their dependencies and source repositories.
